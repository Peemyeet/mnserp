-- -----------------------------------------------------------------------------
-- ใช้เมื่อ API แจ้งว่าไม่มีตาราง workstatus / workgroup
-- รันกับฐานข้อมูลเดียวกับที่ตั้งใน server/.env (MYSQL_DATABASE / database name)
-- ผ่าน mysql CLI, phpMyAdmin, หรือ DBeaver แล้วรีเฟรชแอป
-- หลังรัน: GET /api/jobs และ GET /api/reports/sales ควรได้ 200
-- -----------------------------------------------------------------------------
