-- =============================================================================
-- ERP MNS — รันหลัง import database/db_mns.sql แล้ว (phpMyAdmin หรือ mysql CLI)
-- ไฟล์นี้เติมคอลัมน์ HR/KPI + ตาราง mns_* (AUTO_INCREMENT / TINYINT / DATETIME แบบ MySQL)
-- ถ้า error "Duplicate column" ให้ข้ามบรรทัดนั้น (คอลัมน์มีอยู่แล้ว)
-- =============================================================================
